...
async function testDocumentSystem() {
    ...
    try {
        ...
        console.log('1️⃣ Checking existing patients...');
        ...
        console.log('2️⃣ Checking existing patient documents...');
        ...
        console.log('\n3️⃣ Testing patient documents API endpoint...');
        ...
        console.log('\n4️⃣ Testing patient dashboard stats API...');
        ...
        console.log('\n5️⃣ Testing doctor documents API...');
        ...
        if (doctorError || !doctors.length) {
            console.log('⚠️ No doctors found, skipping doctor API test');
        } else {
        ...
        console.log('\n6️⃣ Testing cross-patient access prevention...');
